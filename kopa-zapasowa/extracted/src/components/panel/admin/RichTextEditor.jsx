      ...
      <div className="overflow-hidden rounded-3xl border border-mauve/15 bg-white">
        ...
        <div className="relative">
          ...
          <div
            ...
            onInput={syncValue}
            className="min-h-55 px-4 py-4 text-fs-body leading-8 text-mauve focus:outline-none [&_blockquote]:border-l-2 [&_blockquote]:border-gold/30 [&_blockquote]:pl-4 [&_blockquote]:italic [&_h2]:font-serif [&_h2]:text-fs-title-sm [&_h2]:text-mauve [&_h3]:font-serif [&_h3]:text-fs-body-lg [&_h3]:text-mauve [&_li]:ml-5 [&_li]:pl-1 [&_ol]:list-decimal [&_ul]:list-disc"
          />
        </div>
      </div>
